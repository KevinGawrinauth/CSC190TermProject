...
# File to store user data (simulates a persistent database)
USER_FILE = 'user_storage.json'

# Kroger API credentials (add your credentials here)
...
# Helper functions to manage user data in a file
def read_users():
...
# Form class for login and registration
...
# Predefined Long Island locations (Fake for demonstration)
locations = [
    {"id": 1, "name": "Long Island - Amityville", "zip_code": "11701"},
    {"id": 2, "name": "Long Island - Hicksville", "zip_code": "11801"},
    {"id": 3, "name": "Long Island - Commack", "zip_code": "11725"},
...
def get_products(category):
    ...
    params = {
        ...
        'filter.limit': 10  # Adjust limit as needed
    }
